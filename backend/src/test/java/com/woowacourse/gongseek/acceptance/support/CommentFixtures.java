...
public class CommentFixtures {
    ...
    public static ExtractableResponse<Response> 댓글을_등록한다(TokenResponse tokenResponse, ArticleIdResponse articleIdResponse) {
        return RestAssured
                .given().log().all()
    ...
    public static List<CommentResponse> 댓글을_조회한다() {
        return RestAssured
                .given().log().all()
                .when()
    ...
    public static ExtractableResponse<Response> 댓글을_수정한다(TokenResponse tokenResponse, ArticleIdResponse articleIdResponse,
    ...
    public static ExtractableResponse<Response> 댓글을_삭제한다(TokenResponse tokenResponse, ArticleIdResponse articleIdResponse,
            List<CommentResponse> commentResponses) {
        return RestAssured
                .given().log().all()
                .pathParam("article_id", articleIdResponse.getId())
