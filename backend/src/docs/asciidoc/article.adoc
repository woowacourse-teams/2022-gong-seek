...
include::{snippets}/articles-get-by-tag/http-request.adoc[]

=== Header

include::{snippets}/articles-get-by-tag/request-parameters.adoc[]

=== Response

include::{snippets}/articles-get-by-tag/http-response.adoc[]
include::{snippets}/articles-get-by-tag/response-fields.adoc[]
